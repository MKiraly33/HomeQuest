package com.mate.kiraly.HomeQuest.userhandling.registration;


import com.mate.kiraly.HomeQuest.userhandling.appuser.AppUser;
import com.mate.kiraly.HomeQuest.userhandling.appuser.AppUserRole;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request){
        ...
        return sendMail(token, request.getEmail(), request.getFirstName());
    }
